        ...
        <Card className="border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-900/20">
          <CardContent className="pt-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <p className="font-semibold text-blue-900 dark:text-blue-100">AI-Powered Financial Analysis</p>
                <p className="text-sm text-blue-800 dark:text-blue-200 mt-1">
                  Click "Categorize All" to let AI analyze and categorize your 669 transactions, then generate personalized insights and recommendations.
                </p>
              </div>
            </div>
          </CardContent>
